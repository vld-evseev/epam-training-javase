...
/**
 * <h1>Задание 6</h1> 
 * Данный класс служит для демонстрации работы классов
 * Notebook и Record.
 *
 * @author Vlad Evseev
 * @version 1.0
...
public class Task6 {
	...
	/*
	 * Данный метод отслеживает пользовательский ввод и, в зависимости от
	 * выбранной опции, выполняет соответствующий метод класса Notebook.
	 */
